...
//               /home/ckpai/ece4300/rsa-benchmark/vivado_rsa_benchmark/vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ip/petalinux_base_proc_sys_reset_0_3/petalinux_base_proc_sys_reset_0_3_stub.v
...
(* CHECK_LICENSE_TYPE = "petalinux_base_proc_sys_reset_0_3,proc_sys_reset,{}" *) (* core_generation_info = "petalinux_base_proc_sys_reset_0_3,proc_sys_reset,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=proc_sys_reset,x_ipVersion=5.0,x_ipCoreRevision=17,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_EXT_RST_WIDTH=4,C_AUX_RST_WIDTH=4,C_EXT_RESET_HIGH=0,C_AUX_RESET_HIGH=0,C_NUM_BUS_RST=1,C_NUM_PERP_RST=1,C_NUM_INTERCONNECT_ARESETN=1,C_NUM_PERP_ARESETN=1}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "proc_sys_reset,Vivado 2025.2" *) 
module petalinux_base_proc_sys_reset_0_3(slowest_sync_clk, ext_reset_in, aux_reset_in, 
...
/* synthesis syn_force_seq_prim="slowest_sync_clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 clock CLK" *) (* x_interface_mode = "slave clock" *) (* x_interface_parameter = "XIL_INTERFACENAME clock, ASSOCIATED_RESET mb_reset:bus_struct_reset:interconnect_aresetn:peripheral_aresetn:peripheral_reset, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN petalinux_base_processing_system7_0_1_FCLK_CLK0, INSERT_VIP 0" *) input slowest_sync_clk /* synthesis syn_isclock = 1 */;
