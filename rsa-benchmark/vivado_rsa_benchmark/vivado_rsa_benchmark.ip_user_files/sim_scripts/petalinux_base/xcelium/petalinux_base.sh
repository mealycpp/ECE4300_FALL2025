...
#
# Script generated by Vivado on Tue Nov 25 00:52:14 PST 2025
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : petalinux_base.sh
...
#
# Usage        : petalinux_base.sh
#                petalinux_base.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                petalinux_base.sh [-rerun]
#                petalinux_base.sh [-reset_run]
#                petalinux_base.sh [-clean]
#                petalinux_base.sh [-reset_log]
#                petalinux_base.sh [-help]
#
...
#                script (type 'petalinux_base.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_22 -libname processing_system7_vip_v1_0_24 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_37 -libname proc_sys_reset_v5_0_17 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_36 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_22 processing_system7_vip_v1_0_24 xil_defaultlib axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_37 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_36)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "petalinux_base.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./petalinux_base.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/ec67/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/9a25/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/f0b6/hdl/verilog" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/ec67/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/9a25/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/f0b6/hdl/verilog" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/ec67/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/9a25/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/f0b6/hdl/verilog" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_register_slice_v2_1_36 $xmvlog_opts +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/ec67/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/9a25/hdl" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/f0b6/hdl/verilog" +incdir+"../../../../vivado_rsa_benchmark.gen/sources_1/bd/petalinux_base/ipshared/00fe/hdl/verilog" +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.petalinux_base xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.petalinux_base -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ckpai/ece4300/rsa-benchmark/vivado_rsa_benchmark/vivado_rsa_benchmark.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log petalinux_base_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./petalinux_base.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: petalinux_base.sh [-help]\n\
Usage: petalinux_base.sh [-step]\n\
Usage: petalinux_base.sh [-lib_map_path]\n\
Usage: petalinux_base.sh [-rerun]\n\
Usage: petalinux_base.sh [-reset_run]\n\
Usage: petalinux_base.sh [-clean]\n\
Usage: petalinux_base.sh [-reset_log]\n\
Usage: petalinux_base.sh [-keep_index]\n\
Usage: petalinux_base.sh [-noclean_files]\n\n\
